...
**Length**: 826 lines, 1 definition(s) + 23 theorem(s)/lemma(s)
...
### [`integrable_fourierIntegral_expDecayFun`](../../OSforGFF/General/FourierTransforms.lean#L583) — Lemma
...
### [`fourier_inversion_exp_decay`](../../OSforGFF/General/FourierTransforms.lean#L621) — Theorem

**Statement**: For $\mu > 0$ and $x \in \mathbb{R}$,
$$\frac{1}{2\pi} \int e^{ikx} \cdot \frac{2\mu}{k^2 + \mu^2}\, dk = e^{-\mu\lvert x \rvert}.$$

**Proof uses**: [`continuous_expDecayFun`](../../OSforGFF/General/FourierTransforms.lean#L540), [`integrable_expDecayFun`](../../OSforGFF/General/FourierTransforms.lean#L547), [`integrable_fourierIntegral_expDecayFun`](../../OSforGFF/General/FourierTransforms.lean#L583), [`fourierIntegral_expDecayFun_eq`](../../OSforGFF/General/FourierTransforms.lean#L554), `Continuous.fourierInv_fourier_eq`, `MeasureTheory.Measure.integral_comp_smul`

---

## The Lorentzian Fourier Transform (Main Result)

### [`fourier_lorentzian_1d`](../../OSforGFF/General/FourierTransforms.lean#L703) — Theorem

**Statement**: For $\mu > 0$ and $x \in \mathbb{R}$,
$$\int_{-\infty}^\infty \frac{e^{ikx}}{k^2 + \mu^2}\, dk = \frac{\pi}{\mu} e^{-\mu\lvert x \rvert}.$$

**Proof uses**: [`fourier_inversion_exp_decay`](../../OSforGFF/General/FourierTransforms.lean#L621)

---

### [`exp_factorization_reflection`](../../OSforGFF/General/FourierTransforms.lean#L746) — Lemma
...
### [`fourier_lorentzian_1d_neg`](../../OSforGFF/General/FourierTransforms.lean#L760) — Theorem

**Statement**: The negative-phase variant:
$$\int_{-\infty}^\infty \frac{e^{-ikx}}{k^2 + \mu^2}\, dk = \frac{\pi}{\mu} e^{-\mu\lvert x \rvert}.$$

**Proof uses**: [`fourier_lorentzian_1d`](../../OSforGFF/General/FourierTransforms.lean#L703)

---

*This file has **1** definition and **23** theorems/lemmas (0 with sorry).*
